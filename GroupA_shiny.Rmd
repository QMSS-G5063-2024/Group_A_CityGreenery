...
---
title: "Group_A_CityGreenery"
output: html_document
runtime: shiny
---
```{r packages, include=FALSE, results='hide', warning=FALSE}
# Load packages.


packages <- c("devtools","knitr","leaflet","shiny","raster",
              "RColorBrewer","shinydashboard","pkgnet","praise",
              "rsconnect", "patchwork", "ggridges", "ggplot2", "sf",
              "dplyr", "tidyr", "lubridate", "leaflet.extras", "tm", "topicmodels",
              "broom", "wordcloud", "plotly", "stringdist", "textclean", "ggthemes","gplots",
...
```{r Junchen dataset import and preprocessing, include=FALSE, results='hide', warning=FALSE}
...
```{r all ui parts, include=FALSE, results='hide', warning=FALSE}
...
```{r shiny-app, echo=FALSE, warning=FALSE}
